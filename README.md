...
Build a professional portfolio site using HTML/CSS. Include a short style guide; follow it to design an aesthetically pleasing layout while creating different kinds of complex HTML elements.
...
* Useful concepts: `float`, `padding`, `margin`, `display`, `overflow`, `clear` and `text-align`.

### Reminder: Submission on BCS

Click here for link https://ml042685.github.io/Responsive-Portfolio/index.html
